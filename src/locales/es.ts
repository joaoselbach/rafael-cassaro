export const es = {
  ...
  about: {
    title: 'Sobre mi',
    description:
      "Me llamo Rafael Cassaro y viajo por el mundo tatuando. Trabajo en diversos países en Europa, América del sur y Norte y siempre buscando conocer nuevos lugares. Atualmente trabajo en Stefanos tattoos, uno de los mas grandes shop en Florida.",
    quality: {
    ...
    tatto: {
      title: '+1000 tatuajes hechos',
      description:
        'Toda esta experiencia dedicada a usted y su proyecto.',
    },
  },
  works: {
  ...
  benefits: {
    first: {
      ...
      description: "Tráeme tus ideas y te ayudaré a transformarlas en un tatuaje único y personal."
    },
    sec: {
      title: "Diseño co-creado",
      description: "Eres parte del proceso creativo. Serás escuchado. ¡Tu opinion importa!"
    },
    third: {
