export const pt = {
  ...
  testimonials: {
    title: 'O que dizem',
    nick: 'Rafael é um dos melhores tatuadores que conheço! Ele foi muito simpático e entusiasmado com a minha ideia, toda a experiência foi ótima. Voltarei em breve para fazer outra tatuagem com ele. O trabalho que ele fez superou todas as minhas expectativas. Eu definitivamente recomendo ele!',
    andres:
      'Foi uma boa experiência fazer uma tatuagem com o Rafael, o desenho final ficou excelente como eu queria, e agradeço ao Rafael pelo excelente trabalho, superou todas as minhas expectativas. Já faz um tempo e a peça cicatrizou super sólida a cor super bem. Em breve estarei pensando no meu novo projeto com o Rafael',
    luis: 'Sou eternamente grata pela qualidade da minha tatuagem, a coloração e cicatrização ficaram perfeitas! Ele superou minha expectativa em 100% e já se tornou meu tatuador oficial. Perdi as contas de quantas vezes fui parado na rua e recebi elogios pela tatuagem, simplesmente sensacional!',
    sabrina:
      'Assim que fui seu trabalho, imediatamente me apaixonei por seu estilo. Entrei em contato com ele por mensagem e ele foi muito investido e gentil desde o início. Esta foi uma das melhores experiências de tatuagem que tive. Ele entendeu exatamente o que eu estava procurando e a tatuagem estava além das minhas expectativas. Se procura um verdadeiro artista, não hesite em contactá-lo'
  },
  location: {
